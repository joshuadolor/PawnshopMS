<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Edit Additional Charge Configuration
        </h2>
    </x-slot>
        ...
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('config.additional-charge-configs.update', $config) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input 
                                    ...
                                    :value="old('start_day', $config->start_day)" 
                                    required 
                                    min="0"
                                />
                            ...
                            <div>
                                ...
                                <x-text-input 
                                    ...
                                    type="number" 
                                    class="mt-1 block w-full" 
                                    :value="old('end_day', $config->end_day)" 
                                    required 
                                    min="0"
                                />
                            ...
                            <div>
                                ...
                                <x-text-input 
                                    ...
                                    step="0.01"
                                    class="mt-1 block w-full" 
                                    :value="old('percentage', $config->percentage)" 
                                    required 
                                    min="0"
                                    max="100"
                                />
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="LD" {{ old('type', $config->type) === 'LD' ? 'selected' : '' }}>LD - Late Days</option>
                                    <option value="EC" {{ old('type', $config->type) === 'EC' ? 'selected' : '' }}>EC - Exceeded Charge</option>
                                </select>
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="renewal" {{ old('transaction_type', $config->transaction_type) === 'renewal' ? 'selected' : '' }}>Renewal</option>
                                    <option value="tubos" {{ old('transaction_type', $config->transaction_type) === 'tubos' ? 'selected' : '' }}>Tubos</option>
                                </select>
